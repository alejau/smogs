...
SEXP smogs(SEXP X0, SEXP y0, SEXP nk0, SEXP groups0, SEXP lambda0, SEXP corrfactor0, SEXP model0, SEXP conveps0, SEXP eps0, SEXP maxiter0,SEXP maxitersg0)
{
  Rcpp::NumericVector lasso_result;
  ...
  assert(lambda >= 0.0);
  assert(model >= 0);
  assert(model < SMOGS_MODEL_COUNT);
  assert(eps > 0.0);
  assert(maxiter > 0);
  assert(maxitersg > 0);
...
SEXP sogl(SEXP X0, SEXP y0, SEXP n0, SEXP groups0, SEXP lambda0, SEXP model0, SEXP conveps0, SEXP eps0, SEXP maxiter0,SEXP maxitersg0)
{
  Rcpp::NumericVector lasso_result;
